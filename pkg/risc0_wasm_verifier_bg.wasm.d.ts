...
export const __wbg_wasmverificationresult_free: (a: number, b: number) => void;
export const wasmverificationresult_valid: (a: number) => number;
export const wasmverificationresult_error: (a: number) => [number, number];
export const wasmverificationresult_journal_hash: (a: number) => [number, number];
export const wasmverificationresult_receipt_type: (a: number) => [number, number];
export const verify_proof: (a: number, b: number, c: number, d: number) => number;
